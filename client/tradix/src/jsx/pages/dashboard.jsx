                                            ...
                                            <div className="widget-card">
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="widget-stat">
                                                        ...
                                                        <h4>$1254.36 <span className="badge badge-success ml-2">+ 06%</span>
                                                        </h4>
                                                    </div>
                                                    {/* <BtcChart /> */}
                                                </div>
                                            ...
                                            <div className="widget-card">
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="widget-stat">
                                                        ...
                                                        <h4>$1254.36 <span className="badge badge-danger ml-2">- 06%</span>
                                                        </h4>
                                                    </div>
                                                    {/* <EthChart /> */}
                                                </div>
                                            ...
                                            <div className="widget-card">
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="widget-stat">
                                                        ...
                                                        <h4>$1254.36 <span className="badge badge-primary ml-2"> 06%</span>
                                                        </h4>
                                                    </div>
                                                    {/* <LtcChart /> */}
                                                </div>
